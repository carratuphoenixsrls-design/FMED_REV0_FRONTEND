...
export default function ScadenzePage(props) {
  const {
    scadenzeVisualizzate, scadenzeConStatoBase, scadenzeSelezionateVisualizzate,
    scadenzeElencoAperto, setScadenzeElencoAperto, scadenzeScadute,
    scadenzeImminenti, scadenzeRenderizzate, chiaveScadenzaExport,
    scadenzeSelezionateExport, statoScadenza, toggleScadenzaExport,
    chiudiScadenzaSingolaComeSostituita, apriSchedaDaCodice,
    normalizzaSocietaDitta, formattaData, setScadenzeRenderLimit,
            ...
            <table>
              ...
              <tbody>
                {scadenzeRenderizzate.map((row, index) => {
                  ...
                  const state = row._statoScadenza || statoScadenza(row._dataScadenza);
                  return (
