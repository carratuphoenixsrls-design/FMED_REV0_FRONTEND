...
<div className="fmed-infrastrutture-page">
    ...
    <div className="fmed-operational-kpi-grid" style={{
      ...
      <div className="fmed-operational-kpi-card" style={styles.assetKpiCard}><div style={styles.assetKpiTop}><span className="fmed-kpi-icon" style={styles.assetKpiIcon}><FmedIcon name="building" /></span><span style={styles.assetKpiLabel}>Totale</span></div><strong style={styles.assetKpiValue}>{infrastruttureFiltrate.length}</strong><span style={styles.assetKpiHint}>scadenze filtrate</span></div>
      <div className="fmed-operational-kpi-card" style={styles.assetKpiCard}><div style={styles.assetKpiTop}><span className="fmed-kpi-icon" style={styles.assetKpiIcon}><FmedIcon name="alert" /></span><span style={styles.assetKpiLabel}>Scadute</span></div><strong style={{
              ...styles.assetKpiValue,
              color: "#FF4D5E"
            }}>{infraScadute.length}</strong><span style={styles.assetKpiHint}>da recuperare</span></div>
      <div className="fmed-operational-kpi-card" style={styles.assetKpiCard}><div style={styles.assetKpiTop}><span className="fmed-kpi-icon" style={styles.assetKpiIcon}><FmedIcon name="clock" /></span><span style={styles.assetKpiLabel}>In scadenza</span></div><strong style={{
              ...styles.assetKpiValue,
              color: "#D99A00"
            }}>{infraInScadenza.length}</strong><span style={styles.assetKpiHint}>entro 30 giorni</span></div>
      <div className="fmed-operational-kpi-card" style={styles.assetKpiCard}><div style={styles.assetKpiTop}><span className="fmed-kpi-icon" style={styles.assetKpiIcon}><FmedIcon name="check" /></span><span style={styles.assetKpiLabel}>OK</span></div><strong style={{
              ...styles.assetKpiValue,
              color: "#2FD37D"
            }}>{infraOk.length}</strong><span style={styles.assetKpiHint}>programmate</span></div>
    </div>

    <div className="fmed-operational-table-card fmed-infrastructure-table-card" style={{
      ...
      {<div className="fmed-infrastructure-table-wrap" style={styles.tableWrap}>
          <table className="fmed-infrastructure-table" style={styles.tableLarge}>
            <thead>
              <tr>
