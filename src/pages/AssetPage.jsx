...
export default function AssetPage(props) {
  const {
    filtrati, cespiti, assetElencoAperto, setAssetElencoAperto, assetAnalisiAperta,
    setAssetAnalisiAperta, assetKpiFiltrati, assetPerSedeFiltrati,
    assetPerRepartoFiltrati, assetPerCostruttoreFiltrati, assetPerStatoFiltrati,
    filtratiRenderizzati, apriSchedaCespite, getCodiceAssetBulk, getBrancaAsset,
    getLocazioneFmed, statoCespite, coloreStatoAsset, assetSelezionatiBulk,
    toggleSelezioneAssetBulk, toggleSelezioneAssetVisibiliBulk,
    assetQuickEditCodice, assetQuickEditForm, aggiornaCampoModificaRapidaAsset,
    apriModificaRapidaAsset, salvaModificaRapidaAsset, annullaModificaRapidaAsset,
    assetQuickEditSaving, listaTipologie, listaSedi, listaBranche,
    getListaLocazioniPerSede, listaCostruttori, listaModelli, STATI_ASSET_STANDARD,
    apiBaseUrl, setAssetRenderLimit, FMED_RENDER_BATCH_ASSET, assetBulkBranca,
    setAssetBulkBranca, assetBulkSocieta, setAssetBulkSocieta, listaSocieta,
    assetBulkSede, setAssetBulkSede, assetBulkLocazione, setAssetBulkLocazione,
    assetBulkStato, setAssetBulkStato, assetBulkSaving,
    salvaModificaMultiplaBrancaAsset, selezionaTuttiAssetFiltratiBulk,
