...
` + `Interventi aggiornati: ${interventiDaAggiornare.length}`);
  ...
  function apriNuovoIntervento(cespite = null) {
    ...
    // e apro direttamente la pagina di inserimento intervento già precompilata.
    if (cespite) {
      setCespiteSelezionato(null);
    }
    setNuovoInterventoOpen(true);
  ...
  async function chiudiNuovoIntervento({ annullaProcesso = true } = {}) {
    if (annullaProcesso && processoNuovoInterventoGuidato && processoGuidatoEsecuzioneId) {
      ...
      if (!annullato) {
        alert("Il processo non è stato annullato dal backend. La pagina resta aperta per non perdere il collegamento; riprova quando la connessione è disponibile.");
        return false;
      }
    }
  ...
  function apriModificaIntervento(intervento) {
    ...
    // Evita la sovrapposizione delle due pagine operative e rende il flusso più chiaro anche da telefono.
    setCespiteSelezionato(null);
    setModificaCespite(false);
    setModificaLinkDoc(false);
    setStoricoCespiteOpen(false);
...
{paginaExportAttiva && permessiRuoloFmed.canExport && <Suspense fallback={<div className="fmed-lazy-loading">Caricamento modulo…</div>}><ExportPage {...{
        ...
        {nuovoInterventoOpen && <section className="fmed-workspace-page fmed-intervention-workspace" aria-labelledby="fmed-new-intervention-title">
    <div className="fmed-workspace-surface fmed-intervention-workspace-surface">
      <button className="fmed-workspace-back fmed-style-close-btn" onClick={() => chiudiNuovoIntervento({ annullaProcesso: true })}>
        <FmedIcon name="close" /> Torna agli interventi
      </button>
      ...
      {(!processoNuovoInterventoGuidato || formNuovoIntervento.codice_strumento) && <div className="fmed-new-intervention-form fmed-style-edit-panel">
        ...
        {modificaInterventoOpen && <section className="fmed-workspace-page fmed-intervention-workspace" aria-labelledby="fmed-edit-intervention-title">
    <div className="fmed-workspace-surface fmed-intervention-workspace-surface">
      ...
      <div className="fmed-literal-bec04a7b4e">
        ...
        <div className="fmed-literal-d87d5ede0c">
          ...
          <label style={{
            ...
            <input type="file" accept="image/*" disabled={ocrTarghettaLoading}
      ...
      <div className="fmed-literal-63b4bb00c8">
        ...
        <div className="fmed-literal-d87d5ede0c">
          ...
          <label style={{
            ...
            <input type="file" accept="image/*" disabled={ocrAccessorioLoading}
...
{modificaCespite && <div className="fmed-style-edit-panel">
    ...
    <div className="fmed-workspace-actions fmed-style-edit-actions">
      ...
      {analisiCespite && <div style={{
            ...
            ...{}
          }} className="fmed-style-asset-kpi-ribbon">
          <div className="fmed-style-asset-kpi-item">
            <span className="fmed-style-asset-kpi-icon-green"></span>
            <div>
          ...
          <div className="fmed-style-asset-kpi-item">
            ...
            <div>
              ...
              <div className="fmed-style-asset-kpi-value">{analisiCespite.punteggio ?? "-"}/100</div>
            </div>
          </div>
          <div className="fmed-style-asset-kpi-item">
            ...
            <div>
              ...
              <div className="fmed-style-asset-kpi-value">{analisiCespite.interventi ?? interventiCespite.length}</div>
            </div>
          </div>
          <div className="fmed-style-asset-kpi-item">
      ...
      <div className="fmed-asset-detail-grid fmed-style-asset-main-grid" style={{
        ...
        {analisiCespite && <div className="fmed-predictive-column">{(() => {
                ...
                return <div className="fmed-predictive-panel fmed-style-asset-panel fmed-style-predictive-panel" style={{
        ...
        <div className="fmed-predictive-recommendations fmed-style-recommendation-panel">
