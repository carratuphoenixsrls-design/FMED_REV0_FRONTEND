...
import styles, { loginLightStyles } from "./fmedInlineStyles.js";
...
const MRDB_APP_VERSION = "FMED_ENTERPRISE_1_0_E8_3_0_FUNCTIONAL_RESTORE_2026_07_26";
const MRDB_APP_BUILD_LABEL = "FMED ENTERPRISE 1.0 · E8.3.0 FUNCTIONAL RESTORE";
...
// ========================================================
const FMED_ALL_MENU_ITEMS = ["Dashboard", "Scopo e Missione", "Asset", "Interventi", "Scadenze", "Infrastrutture", "Sicurezza 81/08", "Processi", "Dizionari", "Gestione Utenti"];
const FMED_MENU_GROUPS = [
  { label: "Panoramica", items: ["Dashboard", "Scopo e Missione"] },
...
const FMED_MENU_HELP = {
  ...
  "Scopo e Missione": "Presenta in una sola pagina cosa fa FMED, come lavorano i moduli e quale valore produce per Marilab.",
...
const FMED_ROLE_PERMISSIONS = {
  Admin: {
    pages: ["Dashboard", "Scopo e Missione", "Asset", "Interventi", "Costi", "Scadenze", "Infrastrutture", "Sicurezza 81/08", "Export", "SharePoint", "Processi", "Dizionari", "Nuovo Asset", "Gestione Utenti"],
    canEdit: true,
    canExport: true,
    canSeeCosts: true,
    canManageUsers: true,
  ...
  Service: {
    pages: ["Dashboard", "Scopo e Missione", "Asset", "Interventi", "Scadenze", "Infrastrutture", "Sicurezza 81/08", "SharePoint", "Processi"],
    canEdit: true,
    canExport: false,
    canSeeCosts: false,
  ...
  User: {
    pages: ["Dashboard", "Scopo e Missione", "Asset", "Scadenze", "Infrastrutture", "Sicurezza 81/08"],
    canEdit: false,
    canExport: false,
    canSeeCosts: false,
    canManageUsers: false,
...
function AppNuovoCore({
  ...
  const [pagina, setPagina] = useState("Scopo e Missione");
...
` + `Interventi aggiornati: ${interventiDaAggiornare.length}`);
  ...
  async function chiudiNuovoIntervento({ annullaProcesso = true } = {}) {
    if (annullaProcesso && processoNuovoInterventoGuidato && processoGuidatoEsecuzioneId) {
      ...
      if (!annullato) {
        alert("Il processo non è stato annullato dal backend. La finestra resta aperta per non perdere il collegamento; riprova quando la connessione è disponibile.");
        return false;
      }
    }
  ...
  function apriMenuAllegaInfrastruttura(record) {
    ...
    if (item === "Scopo e Missione") return <svg {...common}><path d="M12 3 14.2 8.2 20 9l-4.3 3.8 1.2 5.7L12 15.6 7.1 18.5l1.2-5.7L4 9l5.8-.8L12 3Z" stroke={stroke} strokeWidth={1.8} strokeLinejoin="round" /><circle cx="12" cy="12" r="2.2" fill="currentColor" /></svg>;
  ...
  return <div data-fmed-build={MRDB_APP_VERSION} className="fmed-app-root fmed-light-mode fmed-e820-premium fmed-visual-clean" style={{
    ...styles.app,
    ...
    ...{}
      ...
      ...{}
        ...
        ...(sidebarCompattata && true ? styles.sidebarBrandLinkCollapsed : {})
          ...
          {sidebarCompattata && true ? <div className="fmed-sidebar-wordmark-compact" aria-label="F.M.E.D.">F.</div> : <div className="fmed-sidebar-wordmark">
        ...
        <nav className="fmed-sidebar-navigation" style={styles.sidebarNav} aria-label="Funzioni principali FMED">
      ...
      ...{}
        ...
        {pagina === "Scopo e Missione" && <Suspense fallback={<div className="fmed-lazy-loading">Preparazione presentazione FMED…</div>}>
          <MissionPage onNavigate={setPagina} />
        </Suspense>}
...
{paginaExportAttiva && permessiRuoloFmed.canExport && <Suspense fallback={<div className="fmed-lazy-loading">Caricamento modulo…</div>}><ExportPage {...{
    ...
    <div className="fmed-modal-card fmed-asset-detail-modal" style={{
          ...styles.modalCard,
          ...{}
        }}>
    ...
    <div className="fmed-modal-card" style={{
      ...
      <h2 style={styles.modalTitle}> Modifica intervento</h2>
...
{gestioneDizionariOpen && <div className="fmed-modal-overlay" style={styles.modalOverlay}>
    <div style={{
      ...
      <h2 style={styles.modalTitle}> Gestione dizionari Asset</h2>
      <p style={{
            ...styles.muted,
            marginTop: "-6px",
            marginBottom: 18
    ...
    <div className="fmed-modal-card" style={{
      ...
      <button className="fmed-asset-detail-close" style={styles.closeBtn} onClick={() => setCespiteSelezionato(null)}>
        <FmedIcon name="close" /> Chiudi
      </button>
          ...
          <div style={styles.assetActionsGroupBlock}>
            ...
            <div style={{
              ...
              <button onClick={() => {
                ...
                <span style={styles.assetActionIcon}><FmedIcon name="folder" /></span>
              ...
              <button onClick={() => {
                ...
                <span style={styles.assetActionIcon}><FmedIcon name="link" /></span>
              ...
              <button onClick={() => {
                ...
                <span style={styles.assetActionIcon}><FmedIcon name="file" /></span>
          ...
          <div style={styles.assetActionsGroupBlock}>
            ...
            <div style={{
              ...
              <button style={{
                ...
                <span style={styles.assetActionIcon}><FmedIcon name="plus" /></span>
                <span>Nuovo intervento</span>
              </button>

              <button style={styles.assetActionBtn} onClick={apriModificaUltimoInterventoCespite}>
                <span style={styles.assetActionIcon}><FmedIcon name="edit" /></span>
              ...
              <button style={{
                ...
                <span style={styles.assetActionIcon}><FmedIcon name="history" /></span>
          ...
          <div style={styles.assetActionsGroupBlock}>
            ...
            <div style={{
              ...
              <button onClick={() => copiaDatiCespiteInNuovoAsset(cespiteSelezionato)} style={styles.assetActionBtn} title="Copia i dati principali del cespite e apre un nuovo asset modificabile">
                <span style={styles.assetActionIcon}><FmedIcon name="copy" /></span>
              ...
              <button onClick={eliminaCespiteSelezionato} style={{
                ...
                <span style={styles.assetActionIcon}><FmedIcon name="archive" /></span>
                <span>Dismetti</span>
              </button>
            </div>
          </div>
...
{modificaCespite && <div style={styles.editPanel}>
    <h3 style={styles.sectionTitle}> Modifica dati cespite</h3>
    ...
    <div style={styles.editActions}>
      ...
      {analisiCespite && <div style={{
          ...
          <div style={styles.assetKpiItem}>
            <span style={styles.assetKpiIconBlue}>⏱</span>
            <div>
      ...
      <div className="fmed-asset-detail-grid" style={{
          ...
          return <div className="fmed-predictive-panel" style={{
            ...
            <div className="fmed-predictive-grid" style={styles.fmeaGrid}>
              <div className="fmed-predictive-card is-criticality" style={{...styles.fmeaBox, background: stileCriticita.background, border: stileCriticita.border, boxShadow: `inset 4px 0 0 ${stileCriticita.accent}`}}>
                <span style={{...styles.predictiveIcon, background: stileCriticita.soft, color: stileCriticita.color}}></span>
              ...
              <div className="fmed-predictive-card is-risk" style={{...styles.fmeaBox, background: stileRischio.background, border: stileRischio.border, boxShadow: `inset 4px 0 0 ${stileRischio.accent}`}}>
                <span style={{...styles.predictiveIcon, background: stileRischio.soft, color: stileRischio.color}}></span>
        ...
        <div className="fmed-predictive-recommendations" style={styles.recommendationPanel}>
          ...
          <div style={{
            ...
            <div style={{...styles.recommendationBox, ...styles.recommendationBoxInfo}}>
              <div style={{...styles.recommendationTitle, color: "#175CD3"}}>ℹ Raccomandazione</div>
              <p>{safeText(analisiCespite.raccomandazione)}</p>
            </div>
            <div style={{...styles.recommendationBox, ...styles.recommendationBoxTechnical}}>
              <div style={{...styles.recommendationTitle, color: "#6941C6"}}> Motivazione tecnica</div>
...
function AppNuovo() {
  ...
  const loginUi = loginLightStyles;
  if (!sessioneFmed) {
    return <div className="fmed-login-page fmed-e812-login" style={loginUi.page}>
        ...
        <section className="fmed-login-form-panel">
          <div className="fmed-login-card" style={loginUi.card}>
            <div className="fmed-login-kicker" style={loginUi.kicker}>Accesso riservato</div>
            <h1 className="fmed-login-title" style={loginUi.title}>Bentornato in FMED</h1>
            <p className="fmed-login-subtitle" style={loginUi.subtitle}>Inserisci le credenziali aziendali per accedere all’area tecnica.</p>
            ...
            <form className="fmed-login-form" onSubmit={loginSubmit} style={loginUi.form}>
              ...
              <label className="fmed-login-remember" style={loginUi.rememberRow}>
              ...
              {loginErrore ? <div className="fmed-login-error" style={loginUi.error}>{loginErrore}</div> : null}

              <button className="fmed-login-submit" type="submit" disabled={loginLoading} style={loginUi.button}>
                {loginLoading ? "Accesso..." : "Accedi"}
              </button>

              <div className="fmed-login-version" style={loginUi.versionText}>{MRDB_APP_BUILD_LABEL}</div>
            </form>
          </div>
        </section>
      </div>;
