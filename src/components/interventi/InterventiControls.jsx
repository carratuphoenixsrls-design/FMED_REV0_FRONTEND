...
export default function InterventiControls(props) {
  const {
    interventiFiltrati, apriNuovoIntervento, ricercaCespiteIntervento,
    setRicercaCespiteIntervento, cespitiPerNuovoIntervento, apriSchedaCespite,
    labelPeriodoContabileInterventi, filtroInterventiCodice, setFiltroInterventiCodice,
    setInterventiElencoAperto, listaCodiciFiltroInterventi, filtroInterventiSede,
    setFiltroInterventiSede, listaSediInterventi, filtroInterventiSocieta,
    setFiltroInterventiSocieta, listaSocietaInterventi, filtroInterventiTipologia,
    setFiltroInterventiTipologia, listaTipologieFiltroInterventi,
    filtroInterventiAttivita, setFiltroInterventiAttivita, listaAttivitaFiltroInterventi,
    filtroInterventiAnnoContabile, setFiltroInterventiAnnoContabile,
    listaAnniContabiliInterventi, filtroInterventiPeriodoContabile,
    setFiltroInterventiPeriodoContabile, ordineInterventi, setOrdineInterventi,
    filtroInterventiPeriodoDa, setFiltroInterventiPeriodoDa, filtroInterventiPeriodoA,
    setFiltroInterventiPeriodoA, filtroInterventiUltimoDa, setFiltroInterventiUltimoDa,
    filtroInterventiUltimoA, setFiltroInterventiUltimoA, filtroInterventiProssimoDa,
    setFiltroInterventiProssimoDa, filtroInterventiProssimoA,
    setFiltroInterventiProssimoA, interventiElencoAperto, permessiRuoloFmed,
    setPagina, resetFiltriInterventi, esportaInterventiFiltratiPdf
  } = props;
