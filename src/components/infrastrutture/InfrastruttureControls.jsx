...
export default function InfrastruttureControls(props) {
  const {
    infrastruttureFiltrate, ricercaInfra, setRicercaInfra, filtroInfraSede,
    setFiltroInfraSede, listaInfraSedi, filtroInfraCategoria, setFiltroInfraCategoria,
    listaInfraCategorie, filtroInfraStato, setFiltroInfraStato, filtroInfraDitta,
    setFiltroInfraDitta, listaInfraDitte, filtroInfraPeriodicita,
    setFiltroInfraPeriodicita, listaInfraPeriodicita, filtroInfraPriorita,
    setFiltroInfraPriorita, listaInfraPriorita, filtroInfraResponsabile,
    setFiltroInfraResponsabile, listaInfraResponsabili, filtroInfraCentroCosto,
    setFiltroInfraCentroCosto, listaInfraCentriCosto, filtroInfraSocieta,
    setFiltroInfraSocieta, listaInfraSocieta, filtroInfraProssimaDa,
    setFiltroInfraProssimaDa, filtroInfraProssimaA, setFiltroInfraProssimaA,
    permessiRuoloFmed, apriNuovaInfrastruttura, caricaInfrastruttureOnDemand,
    infrastruttureLoading, resetFiltriInfrastrutture
  } = props;
