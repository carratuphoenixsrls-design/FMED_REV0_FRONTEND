...
export default function InfrastrutturaEditor(props) {
  const {
    infraInModifica, formInfra, aggiornaFormInfra, SEDI_STANDARD_LIST,
    infraCategorieStandard, infraDitteOptions, infraPeriodicitaStandard,
    infraStatiStandard, PRIORITA_STANDARD, infraSocietaOptions,
    infraCentroCostoOptions, messaggioInfra, salvaInfrastruttura,
    salvataggioInfraLoading, setFormInfrastrutturaOpen, apiBaseUrl,
    apriMenuAttivitaInfrastruttura, apriMenuDocumentazioneInfrastruttura,
    apriReportInfrastruttura, apriMenuAllegaInfrastruttura
  } = props;
