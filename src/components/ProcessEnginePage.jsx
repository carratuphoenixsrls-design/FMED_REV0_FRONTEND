...
export default function ProcessEnginePage({ process, apiBaseUrl, onClose, onCreated }) {
  ...
  return (
    <section className="fmed-workspace-page fmed-process-create-page" aria-labelledby="fmed-process-page-title">
      <div className="fmed-workspace-surface fmed-process-form-surface">
        <header>
          <div>
            <span>{process.modulo?.replaceAll("_", " ")}</span>
            <h3 id="fmed-process-page-title">{process.titolo}</h3>
            <p>{process.descrizione}</p>
          </div>
          <button type="button" className="fmed-process-form-close" onClick={onClose} disabled={busy}>Torna ai processi</button>
        </header>

        <form onSubmit={submit}>
          <div className="fmed-process-form-grid">
            <label className="fmed-process-form-field is-wide">
            ...
            {(process.richiede_elemento || elementOptions.length > 0) && <label className="fmed-process-form-field">
            ...
            <label className="fmed-process-form-field">
              <span>Scadenza</span>
          ...
          <aside className="fmed-process-form-requirements">
            <strong>Controlli workflow</strong>
          ...
          {message && <div className="fmed-process-form-message">{message}</div>}
