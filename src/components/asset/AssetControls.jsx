...
export default function AssetControls(props) {
  const {
    filtrati, sede, categoriaFiltro, assetLocazioneFiltro, assetStatoFiltro,
    ricerca, setRicerca, setAssetElencoAperto, setSede, setAssetLocazioneFiltro,
    listaSediAsset, setCategoriaFiltro, listaCategorie, formatCategoria,
    assetRepartoFiltro, setAssetRepartoFiltro, listaBranche, listaLocazioniAsset,
    assetTipologiaFiltro, setAssetTipologiaFiltro, listaTipologie,
    assetCostruttoreFiltro, setAssetCostruttoreFiltro, listaCostruttori,
    assetModelloFiltro, setAssetModelloFiltro, listaModelli,
    assetSocietaFiltro, setAssetSocietaFiltro, listaSocieta,
    setAssetStatoFiltro, listaStatiAsset, ordineCodiceAsset, setOrdineCodiceAsset,
    setAssetAnalisiAperta, setAssetBulkBranca, setAssetBulkSede,
    setAssetBulkLocazione, setAssetBulkStato, setAssetBulkSocieta,
    setAssetSelezionatiBulk, setCodiceCespiteAutomatico, avviaProcessoGuidatoFmed,
    setImpostazioniTab, setPagina
  } = props;
