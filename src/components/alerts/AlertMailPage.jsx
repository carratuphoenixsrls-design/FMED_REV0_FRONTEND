...
export default function AlertMailPage({
  open,
  onClose,
  onSend,
  onCheck,
  ...
  return (
    <section className="fmed-workspace-page fmed-alert-mail-page" aria-labelledby="fmed-alert-page-title">
      <div className="fmed-workspace-surface fmed-alert-page">
        <header>
          <div>
          ...
          <button type="button" className="fmed-alert-page-close" onClick={onClose} disabled={busy}>Torna indietro</button>
        </header>
        ...
        {status && (
          <div className={`fmed-alert-page-status ${status.ok ? "is-ok" : "is-error"}`} role="status">
