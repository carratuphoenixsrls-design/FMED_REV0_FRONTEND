    ...
    <section className={`fmed-process-page ${launching || selectedExecution ? "is-workspace-open" : ""}`}>
      ...
      {selectedExecution && <section className="fmed-workspace-page fmed-process-detail-page">
        <div className="fmed-workspace-surface fmed-process-detail is-complete">
          ...
          <section className="fmed-process-state-help"><div><span>STATO DEL PROCESSO</span><strong>{STATUS_LABELS[String(selectedExecution.stato || "").toUpperCase()] || selectedExecution.stato}</strong></div><p>Usa i pulsanti qui sotto per avanzare. Quando raggiunge <strong>Completato</strong>, torna al registro e scegli <strong>Archivia</strong>: il processo sparirà dagli Attivi ma resterà consultabile nello storico.</p></section>
